...
{
    public class QualificationsCollectionEditorModel
    {
        public QualificationsCollectionEditorModel()
        {
            Entities = new List<QualificationEditorModel>();
            Entities.Add(new QualificationEditorModel());
        }

        public QualificationsCollectionEditorModel(IEnumerable<Qualification> collection)
        {
            Entities = new List<QualificationEditorModel>();
