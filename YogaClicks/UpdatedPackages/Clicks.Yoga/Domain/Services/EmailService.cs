...
namespace Clicks.Yoga.Domain.Services
{
    public class EmailService : ServiceBase, IEmailService
    {
        ...
        public void SendStoryEmail(string emailAddress, string toName, string fromName, int storyId)
        {
            var rm = new System.Resources.ResourceManager("Clicks.Yoga.Emails.Resources.Emails", this.GetType().Assembly);
            var body = rm.GetString("StoryInvite");
          //  body = body.Replace("[Sendername]", Capitalize(fromName)).Replace("[StoryIF]", storyId.ToString()); ;
            SendEmail(emailAddress, "It's official " + toName + ", you're an inspiration to " + fromName, body);
        }
