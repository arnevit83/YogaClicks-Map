...
{
    public class VenueAmenityChooserModel : MultipleEntitySelectorModel<VenueAmenity, VenueAmenityModel>
    {
        public VenueAmenityChooserModel() { }

        public VenueAmenityChooserModel(IEnumerable<VenueAmenity> entities) : base(entities) {}
