...
namespace Clicks.Yoga.Domain.Services
{
    public class AuthenticationService : ServiceBase, IAuthenticationService
    {
        ...
        public void AuthenticateNonActiveuserWithPassword(string username, string password, bool persist)
        {
        ...
        public String[] AuthenticateWithFacebookForYogaMap(string accessToken)
        {
            dynamic details = null;
            ...
            try
            {
                details = client.Get("me", new { fields = "id,email,first_name,last_name,gender,location" });
            ...
            string[] strings = new string[] { userId, location };
