...
using Clicks.Yoga.Portal.Controllers;
...
namespace Clicks.Yoga.Portal.Models.Entities
{
    public class TeacherModel : PrincipalEntityModel<Teacher>
    {
        ...
        public IList<TeacherAccreditationModel> Accreditationstherapy { get; private set; }

        

        public bool Stubbed { get; set; }

        public bool Accreditedyogatherapist { get; set; }
        ...
        public override void Populate(Teacher entity)
        {
            ...
            Accreditedyogatherapist = entity.IsAccredited;
            HoursTraining = entity.HoursTraining;
            YearsTeaching = entity.YearsTeaching;
            ...
            Accreditationstherapy = new List<TeacherAccreditationModel>();
            ...
            foreach (var accreditation in entity.Accreditations)
            {
                ...
                if (accreditation.AccreditationBody.Abbreviation == "BCYT" ||
                    accreditation.AccreditationBody.Abbreviation == "IAYT" ||
                    accreditation.AccreditationBody.Abbreviation == "AAYT")
                {
                    Accreditationstherapy.Add(new TeacherAccreditationModel(accreditation));
                }
                else
                {
