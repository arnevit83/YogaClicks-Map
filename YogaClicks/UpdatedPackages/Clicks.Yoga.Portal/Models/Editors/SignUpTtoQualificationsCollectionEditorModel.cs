...
{
    public class SignUpTtoQualificationsCollectionEditorModel
    {
        public SignUpTtoQualificationsCollectionEditorModel()
        {
            Entities = new List<TtoQualificationEditorModel>();
            Entities.Add(new TtoQualificationEditorModel());
        }

        public SignUpTtoQualificationsCollectionEditorModel(IEnumerable<TeacherTrainingOrganisationQualification> collection)
        {
            Entities = new List<TtoQualificationEditorModel>();
