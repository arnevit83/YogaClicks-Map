...
namespace Clicks.Yoga.Portal.Models.Editors
{
    ...
    {
        public AddressEditorModel()
        {
            Country = new CountrySelectorModel();
        }

        public AddressEditorModel(Address address) : this()
        {
        ...
        public AddressEditorModel(Address address, IEnumerable<Country> countries) : this(address)
        {
