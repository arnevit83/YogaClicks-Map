...
namespace Clicks.Yoga.Portal.Controllers
{
    public class TeachersController : YogaController
    {
        ...
        public ActionResult CreateStubbed(string name, string location, double latitude, double longitude, string email)
        {
            ...
            {
                teacher = TeacherService.CreateStubbed(name, new Location { Name = name, Coordinates = new GeographicPoint(latitude, longitude) }, email);
            }
            else
            {
                teacher = TeacherService.CreateStubbed(name, new Location { Name = name, Coordinates = new GeographicPoint(latitude, longitude) });
            }
