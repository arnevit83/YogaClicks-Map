...
namespace Clicks.Yoga.Portal.Controllers
{
    public class AccountController : YogaController
    {
        ...
        {
            if (SecurityContext.Authenticated) return RedirectInternal(destination);
        ...
        public ActionResult Authenticate(AccountLoginModel model)
        {
            ...
            if (!SecurityContext.Authenticated)
            {
                ...
                {
                    model.Validation = "Your account has not been activated. Check your inbox for the activation email and follow the link provided";
                }
                else
                {
                    model.Validation = "Incorrect email / password combination";
        ...
        public ActionResult Logout()
        {
            ...
            SecurityContext.DisableYogaMeds();
