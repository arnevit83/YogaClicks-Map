...
namespace Clicks.Yoga.Portal.Controllers
{
    public class SearchController : YogaController
    {
        ...
        public ActionResult Teachers(SearchCriteriaModel model)
        {
            ...
            return View(new SearchTeachersModel(model, Search(model)));
        }
        ...
        public ActionResult TeachersNavigation(string action = "Teachers")
        {
            ...
            var model = new SearchTeachersNavigationModel(action, criteria, TeacherService.GetTeacherServices(), StyleService.GetStyles(), AccreditationBodyService.GetAccreditationBodies());
            return View(model);
        }
        ...
        {
            var criteria = GetSearchCriteria();
            var model = new SearchVenuesNavigationModel(action, criteria, VenueService.GetVenueServices(), VenueService.GetVenueTypes(), StyleService.GetStyles());
        ...
        {
            var criteria = GetSearchCriteria();
            var model = new SearchTeacherTrainingNavigationModel(criteria, StyleService.GetStyles(), AccreditationBodyService.GetAccreditationBodies());
