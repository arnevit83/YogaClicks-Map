...
namespace Clicks.Yoga.Domain.Services
{
    public class TeacherTrainingService : ServiceBase, ITeacherTrainingService
    {
        ...
        public void AddFaculty(TeacherTrainingOrganisation tto, Teacher teacher)
        {
            if (tto == null)
            ...
            var placement = new TeacherTrainingOrganisationFaculty
            {
            ...
            tto.Faculty.Add(placement);
          
        }
            public void RemoveFaculty(TeacherTrainingOrganisation tto, Teacher teacher)
        {
            if (tto == null)
                throw new ArgumentNullException("tto");
            if (teacher == null)
            ...
            var placement = tto.Faculty.FirstOrDefault(e => e.FacultyMember.Id == teacher.Id);

                EntityContext.TeacherTrainingOrganisationFacultys.Remove(placement);
