...
namespace Clicks.Yoga.Portal.Controllers
{
    public class FansController : YogaController
    {
        ...
        public ActionResult IconButton(int entityId, string entityTypeName, bool newsfeed = false)
        {
            bool isFanned = false;
            bool canFan = false;
        ...
        public ActionResult FanIcon(int entityId, string entityTypeName, bool newsfeed = false)
        {
            ...
            return View("IconButton", vm);
        }

        public ActionResult UnFanIcon(int entityId, string entityTypeName, bool newsfeed = false)
        {
            if (SecurityContext.Authenticated && !SecurityContext.CurrentProfile.Professional)
            {
