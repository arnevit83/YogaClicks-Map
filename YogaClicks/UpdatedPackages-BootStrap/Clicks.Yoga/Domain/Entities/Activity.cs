...
namespace Clicks.Yoga.Domain.Entities
{
    public class Activity : PrincipalEntity, IEntityHandle, IGalleryAssociate, INamed, ISearchable, IProfileBanner
    {
        ...
        public void PopulateSearchRecord(SearchRecord record)
        {
            ...
            {
                record.City = Venue.Address.City;
                record.Area = Venue.Address.Area;
                record.Country = Venue.Address.Country != null ? Venue.Address.Country.EnglishName : null;
                record.Postcode = Venue.Address.Postcode;
