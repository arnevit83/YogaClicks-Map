...
namespace Clicks.Yoga.Portal.Controllers
{
    public class GroupsController : YogaController
    {
        ...
        public ActionResult Update(int id)
        {
            ...
            return View(new GroupUpdateModel(group).PopuplateMetadata(group, permissions, ProfileService, StyleService));
        }
        ...
        public ActionResult Update(int id, GroupUpdateModel model)
        {
            ...
            model.PopulateEntity(group, SecurityContext, EntityService, ImageService, StyleService);
            WorkUnit.Commit();
