...
{
    public class SignUpVenueSelectorCreatorModel
    {
        ...
        public SignUpVenueSelectorCreatorModel()
        {
        ...
        public SignUpVenueSelectorCreatorModel(Address address) : this()
        {
        ...
        public SignUpVenueSelectorCreatorModel(Address address, IEnumerable<Country> countries)
            : this(address)
        {
