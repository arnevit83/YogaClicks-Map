...
namespace ASP.NET_MVC5_Bootstrap3_3_1_LESS
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            var cssmini = new CssMinify();
            var nullOrderer = new NullOrderer();

            var cssBundle = new StyleBundle("~/bundles/css");
            cssBundle.Include("~/Content/Site.less", "~/Content/bootstrap/bootstrap.less", "~/Content/font-awesome/font-awesome.less");
            cssBundle.Transforms.Add(cssTransformer);
            cssBundle.Transforms.Add(cssmini);
            ...
            bootstrapBundle.Include("~/Scripts/bootstrap.js", "~/Scripts/respond.js", "~/Scripts/Scripts.js");
