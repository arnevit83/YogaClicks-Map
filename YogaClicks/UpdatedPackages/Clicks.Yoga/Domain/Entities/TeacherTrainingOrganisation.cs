...
namespace Clicks.Yoga.Domain.Entities
{
    public class TeacherTrainingOrganisation : PrincipalEntity, IActor, IClaimable, IFanable, INamed, ISearchable, IProfileBanner, IGalleryAssociate, IReviewable
    {
        ...
        public virtual ICollection<TeacherTrainingOrganisationAccreditation> Accreditations { get; private set; }

        public virtual ICollection<TeacherTrainingOrganisationQualification> Qualifications { get; set; }
        ...
        public virtual ICollection<TeacherTrainingOrganisationFaculty> Faculty { get; set; }
        ...
        public void PopulateSearchRecord(SearchRecord record)
        {
            ...
            record.UpdateEntities(new List<IEnumerable<INamed>> { Styles, Conditions });
