...
namespace Clicks.Yoga.Portal.Controllers
{
    public class TeachersController : YogaController
    {
        ...
        public ActionResult Display(int id)
        {
            ...
            return View(new TeacherDisplayModel(teacher, profile, visible));
        }
        ...
        public ActionResult Update(int id)
        {
            ...
            return View(new TeacherUpdateModel(teacher).PopulateMetadata(teacher, StyleService, TeacherService, AccreditationBodyService));
        }
        ...
        public ActionResult Update(int id, TeacherUpdateModel model)
        {
            ...
            if (!ModelState.IsValid) return View(model.PopulateMetadata(teacher, StyleService, TeacherService, AccreditationBodyService));

            model.PopulateEntity(teacher, ImageService, StyleService, TeacherService, AccreditationBodyService, WebsiteService, QualificationService);
