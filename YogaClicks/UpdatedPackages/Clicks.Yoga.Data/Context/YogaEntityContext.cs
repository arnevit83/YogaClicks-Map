...
namespace Clicks.Yoga.Data
{
    public class YogaEntityContext : IEntityContext, IWorkUnit
    {
        ...
        [Inject]
        public IRepository<YmStory> YmStory { get; private set; }

        [Inject]
        public IRepository<YmStoryLifeChallenge> YmStoryLifeChallenges { get; private set; }

        [Inject]
        public IRepository<YmStoryLifeChallengeBucket> YmStoryLifeChallengeBuckets { get; private set; }
        ...
        [Inject]
        public IRepository<ActivityVenue> ActivityVenue { get; private set; }
        ...
        [Inject]
        public IRepository<PoseUserImages> PoseUserImages { get; private set; }
        ...
        [Inject]
        public IRepository<TeacherTrainingOrganisationFaculty> TeacherTrainingOrganisationFacultys { get; private set; }
        ...
        [Inject]
        public IRepository<TeacherTrainingOrganisationQualification> TeacherTrainingOrganisationsQualifications { get; private set; }
        ...
        [Inject]
        public IRepository<Gdrp> GDRPs { get;  set; }
