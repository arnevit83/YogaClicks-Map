...
{
    public class SignUpAddressEditorModel
    {
        public SignUpAddressEditorModel()
        {
            Country = new CountrySelectorModel();
        }

        public SignUpAddressEditorModel(Address address) : this()
        {
        ...
        public SignUpAddressEditorModel(Address address, IEnumerable<Country> countries)
            : this(address)
        {
