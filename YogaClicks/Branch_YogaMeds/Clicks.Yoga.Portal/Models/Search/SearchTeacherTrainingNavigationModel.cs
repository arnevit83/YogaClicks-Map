...
namespace Clicks.Yoga.Portal.Models.Search
{
    ...
    {
        public SearchTeacherTrainingNavigationModel(SearchCriteriaModel criteria, IEnumerable<Style> styles, IEnumerable<Condition> conditions, IEnumerable<AccreditationBody> accreditations)
        {
            Criteria = criteria;
