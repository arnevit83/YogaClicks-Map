...
namespace Clicks.Yoga.Context
{
    public interface IEntityContext
    {
        ...
        IRepository<ActivityVenue> ActivityVenue { get; }
        ...
        IRepository<PoseUserImages> PoseUserImages { get; }
        ...
        IRepository<TeacherTrainingOrganisationQualification> TeacherTrainingOrganisationsQualifications { get; }
        IRepository<TeacherTrainingOrganisationFaculty> TeacherTrainingOrganisationFacultys { get; }
        IRepository<YmStory> YmStory { get; }
        IRepository<Gdrp> GDRPs { get; }
        IRepository<YmStoryLifeChallenge> YmStoryLifeChallenges { get; }
        IRepository<YmStoryLifeChallengeBucket> YmStoryLifeChallengeBuckets { get; }
