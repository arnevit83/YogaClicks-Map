(function ($) {
    $.fn.yogaSignupLocationPicker = function (options) {
        if (!options) options = {};
        ...
        var updateAddress = function (result) {
            ...
            $container.addClass("addresswrapper");
        ...
        var locate = function (result) {
            if ($(".venueWrap > div > input").length > 0) {
                $(".venueWrap > div > input").hide();
                $(".venueWrap > div > .suggestionsContainer").hide();
            } else {
                $("#signup-address-editor > input").hide();
            }
