...
{
    public class SignUpWebsiteCollectionEditorModel
    {
        public SignUpWebsiteCollectionEditorModel()
        {
            Entities = new List<WebsiteEditorModel>();
            Entities.Add(new WebsiteEditorModel());
        }

        public SignUpWebsiteCollectionEditorModel(IEnumerable<Website> collection)
        {
            Entities = new List<WebsiteEditorModel>();
