...
namespace Clicks.Yoga.Portal.Controllers
{
    public class StyleOrganisationsController : YogaController
    {
        ...
        [HttpPost]
        [YogaAuthorize]
        public ActionResult CreateStep1(OrganisationCreateStep1Model model, [Deserialize] OrganisationCreateModel createModel)
        {
            ViewBag.CreateModel = createModel;
        ...
        [HttpPost]
        [YogaAuthorize]
        public ActionResult CreateStep2(OrganisationCreateStep2Model model, [Deserialize] OrganisationCreateModel createModel)
        {
            ViewBag.CreateModel = createModel;
        ...
        [HttpPost]
        [YogaAuthorize]
        public ActionResult CreateStep3(OrganisationCreateStep3Model model, [Deserialize] OrganisationCreateModel createModel)
        {
            ViewBag.CreateModel = createModel;
            ...
            return RedirectToAction("CongratulationsProfileCreated", "Profiles", new { id = organisation.Id, profileType = ProfileTypeEnum.SO });
        }
