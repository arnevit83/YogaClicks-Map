...
namespace Clicks.Yoga.Portal.Models.Activities
{
    ...
    public class ActivityCreateStep2Model
    {
        ...
        public void PopulateEntity(Activity entity, IStyleService styleService, IMedicService medicService)
        {
        ...
        public ActivityCreateStep2Model PopulateMetadata(IStyleService styleService, IMedicService medicService)
        {
