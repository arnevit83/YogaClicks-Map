...
namespace Clicks.Yoga.Portal.Models.TeacherTrainingOrganisations
{
    public class OrganisationUpdateModel : ISecurable
    {
        ...
        public OrganisationUpdateModel(TeacherTrainingOrganisation entity, IAddressService addressService, IStyleService styleService, IMedicService medicService)
        {
            EntityId = entity.Id;
