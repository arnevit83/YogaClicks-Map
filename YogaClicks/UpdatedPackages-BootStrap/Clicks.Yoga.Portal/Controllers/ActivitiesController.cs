...
namespace Clicks.Yoga.Portal.Controllers
{
    public class ActivitiesController : YogaController
    {
        ...
        public ActionResult Navigation()
        {
            ...
            return PartialView(new ActivityNavigationModel(criteria, ActivityService.GetActivityTypes(), StyleService.GetStyles(), ActivityService.GetAbilityLevels()));
        }
        ...
        public ActionResult Update(int id)
        {
            ...
            return View(new ActivityUpdateModel(activity).PopulateMetadata(activity, ActivityService, ProfileService, StyleService));
        }
        ...
        public ActionResult Update(int id, ActivityUpdateModel model)
        {
            ...
            if (!ModelState.IsValid) return View(model.PopulateMetadata(activity, ActivityService, ProfileService, StyleService));

            model.PopulateEntity(activity, SecurityContext, ActivityService, EntityService, ImageService, StyleService);
            WorkUnit.Commit();
        ...
        public ActionResult UpdateClass(int id)
        {
            var activity = ActivityService.GetActivityForEditing(id);
            if (!activity.Type.IsClass) throw new PermissionDeniedException();
            return View(new ActivityUpdateClassModel(activity).PopulateMetadata(activity, ActivityService, ProfileService, StyleService));
        }
        ...
        public ActionResult UpdateClass(int id, ActivityUpdateClassModel model)
        {
            ...
            model.PopulateEntity(activity, SecurityContext, ActivityService, EntityService, StyleService);
            WorkUnit.Commit();
        ...
        public ActionResult CreateStep1(ActivityCreateStep1Model model)
        {
            ...
            else
            {
                ...
                ViewBag.ActivityTypeName = type.Name;
                createModel.Step1Model = model;
                return View("CreateStep2", new ActivityCreateStep2Model().PopulateMetadata(StyleService));
            }
        }
        ...
        public ActionResult CreateStep2(ActivityCreateStep2Model model, string createModel, string createmodel2)
        {
            ...
            {
                ViewBag.CreateModel = devtemp;
                return View(model.PopulateMetadata(StyleService));
            }
            devtemp.Step2Model = model;
        ...
        public ActionResult CreateStep3(ActivityCreateStep3Model model, string createModel2, string createModel3)
        {
            ...
            if (model.Back)
            {
                ...
                ViewBag.CreateModel2 = devtemp;
                ModelState.Clear();
                return View("CreateStep2", devtemp.Step2Model.PopulateMetadata(StyleService));
            }
        ...
        public ActionResult CreateStep4(ActivityCreateStep4Model model, string createModel3)
        {
            ...
            devtemp.PopulateEntity(activity, SecurityContext, ActivityService, EntityService, TeacherService, VenueService, StyleService);
        ...
        public ActionResult CreateClassStep2(ActivityCreateClassStep2Model model, string createModel, string createmodel02)
        {
          ...
          //  ViewBag.CreateModel02 = devtemp;
            ...
            devtemp.Step2Model = model;
            return View("CreateClassStep3", new ActivityCreateClassStep3Model().PopulateMetadata(StyleService));
        }
        ...
        public ActionResult CreateClassStep4(ActivityCreateClassStep4Model model, string createModel03, string createModel04)
        {
          ...
          //  ViewBag.CreateModel04 = devtemp;
            ...
            if (model.Back)
            {
                ...
                ViewBag.CreateModel03 = devtemp;
                ModelState.Clear();
                return View("CreateClassStep3", devtemp.Step3Model.PopulateMetadata(StyleService));
            }
        ...
        public ActionResult CreateClassStep5(ActivityCreateClassStep5Model model, string createModel04)
        {
           ...
           // ViewBag.CreateModel05 = devtemp;
            ...
            {
                var activity = new Activity { Owner = SecurityContext.CurrentUser };
                devtemp.PopulateEntity(activity, SecurityContext, ActivityService, EntityService, StyleService, TeacherService, VenueService);
                ActivityService.CreateActivity(activity);
        ...
        private int CreateWeeklyRepeats(ActivityCreateClassModel createModel)
        {
            ...
            if (createModel.Step2Model.RepeatMonday)
            {
                ...
                createModel.PopulateEntity(mondayActivity, SecurityContext, ActivityService, EntityService, StyleService, TeacherService, VenueService);
            ...
            if (createModel.Step2Model.RepeatTuesday)
            {
                ...
                createModel.PopulateEntity(tuesdayActivity, SecurityContext, ActivityService, EntityService, StyleService, TeacherService, VenueService);
            ...
            if (createModel.Step2Model.RepeatWednesday)
            {
                ...
                createModel.PopulateEntity(wednesdayActivity, SecurityContext, ActivityService, EntityService, StyleService, TeacherService, VenueService);
            ...
            if (createModel.Step2Model.RepeatThursday)
            {
                ...
                createModel.PopulateEntity(thursdayActivity, SecurityContext, ActivityService, EntityService, StyleService, TeacherService, VenueService);
            ...
            if (createModel.Step2Model.RepeatFriday)
            {
                ...
                createModel.PopulateEntity(fridayActivity, SecurityContext, ActivityService, EntityService, StyleService, TeacherService, VenueService);
            ...
            if (createModel.Step2Model.RepeatSaturday)
            {
                ...
                createModel.PopulateEntity(saturdayActivity, SecurityContext, ActivityService, EntityService, StyleService, TeacherService, VenueService);
            ...
            if (createModel.Step2Model.RepeatSunday)
            {
                ...
                createModel.PopulateEntity(sundayActivity, SecurityContext, ActivityService, EntityService, StyleService, TeacherService, VenueService);
