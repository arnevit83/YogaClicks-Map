...
namespace Clicks.Yoga.Portal.Models.Search
{
    ...
    {
        public SearchTeachersNavigationModel(string action, SearchCriteriaModel criteria, IEnumerable<TeacherService> services, IEnumerable<Style> styles, IEnumerable<AccreditationBody> accreditations)
        {
            Action = action;
            Criteria = criteria;
